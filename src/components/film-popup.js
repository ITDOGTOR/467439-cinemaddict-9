export const createFilmPopupTemplate = ({poster, title, originalTitle, rating, director, writers, actors, releaseDate, duration, country, genres, description, ageRating, comments, isWatchlist, isWatched, isFavorites}) => {
